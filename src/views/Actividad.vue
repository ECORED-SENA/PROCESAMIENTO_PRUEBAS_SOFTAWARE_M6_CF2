  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        ...
        p.mb-4 Cuestionario de aseguramiento de la calidad de <i>software</i>.
        .tarjeta.tarjeta--azul.p-3
          .row.justify-content-around.align-items-center
            .col-sm.mb-3.mb-sm-0
              p.fw-bold.mb-0 El objetivo de esta actividad es que el aprendiz pueda reconocer los diferentes conceptos del aseguramiento de la calidad de software y sus características.
            .col-auto
